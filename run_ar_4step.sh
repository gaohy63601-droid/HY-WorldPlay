#!/usr/bin/env bash
# Inference with HY-World1.5-Autoregressive-480P-I2V-distill (4-step distilled).
set -euo pipefail
...
OUTPUT_PATH="${OUTPUT_PATH:-${ROOT_DIR}/outputs/ar_4step_distilled}"
...
AR_DISTILL_ACTION_MODEL_PATH="${AR_DISTILL_ACTION_MODEL_PATH:-/home/Yirenteam/.cache/huggingface/hub/models--tencent--HY-WorldPlay/snapshots/f4c29235647707b571479a69b569e4166f9f5bf8/ar_distilled_action_model/diffusion_pytorch_model.safetensors}"
