#!/usr/bin/env bash
# Inference with HY-World1.5-Bidirectional-480P-I2V (50-step bidirectional baseline).
set -euo pipefail
...
OUTPUT_PATH="${OUTPUT_PATH:-${ROOT_DIR}/outputs/bi_50step}"
...
BI_ACTION_MODEL_PATH="${BI_ACTION_MODEL_PATH:-/home/Yirenteam/.cache/huggingface/hub/models--tencent--HY-WorldPlay/snapshots/f4c29235647707b571479a69b569e4166f9f5bf8/bidirectional_model/diffusion_pytorch_model.safetensors}"
