...
class TrainingArgs(TrainerArgs):
    ...
    # flow-map causal student training
    flowmap_training: bool = False
    flowmap_gate_value: float = 0.25
    flowmap_deltatime_type: str = "r"
    flowmap_diffusion_ratio: float = 0.5
    flowmap_consistency_ratio: float = 0.25
    flowmap_epsilon: float = 5.0
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument("--flowmap-training",
                            action=StoreBoolean,
                            help="Enable flow-map causal student training")
        parser.add_argument("--flowmap-gate-value",
                            type=float,
                            default=TrainingArgs.flowmap_gate_value,
                            help="Flow-map r-timestep embedding gate value")
        parser.add_argument("--flowmap-deltatime-type",
                            type=str,
                            default=TrainingArgs.flowmap_deltatime_type,
                            help="Flow-map delta-time conditioning type")
        parser.add_argument("--flowmap-diffusion-ratio",
                            type=float,
                            default=TrainingArgs.flowmap_diffusion_ratio,
                            help="Ratio of samples with r=t")
        parser.add_argument("--flowmap-consistency-ratio",
                            type=float,
                            default=TrainingArgs.flowmap_consistency_ratio,
                            help="Ratio of samples with r=0")
        parser.add_argument("--flowmap-epsilon",
                            type=float,
